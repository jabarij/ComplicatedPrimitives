...
{
    public static readonly Range<T> Empty = new();
    public static readonly Range<T> Infinite = new(LimitValue<T>.Infinity, LimitValue<T>.Infinity);
    ...
    public Range(T left, T right, LimitType leftLimit = default, LimitType rightLimit = default)
