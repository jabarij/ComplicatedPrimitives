...
public readonly struct DirectedLimit<T> :
    IEquatable<DirectedLimit<T>>,
    IComparable<DirectedLimit<T>>
    where T : IComparable<T>
{
    public static readonly DirectedLimit<T> Undefined = new();
    public static readonly DirectedLimit<T> LeftInfinity = new(LimitValue<T>.Infinity, LimitSide.Left);
    public static readonly DirectedLimit<T> RightInfinity = new(LimitValue<T>.Infinity, LimitSide.Right);
    ...
    public override int GetHashCode() =>
        HashCode.Combine(LimitValue, Side);
