...
public readonly struct CaseInsensitiveString : IEquatable<CaseInsensitiveString>, IEquatable<string>
{
    ...
    public static bool Equals(CaseInsensitiveString a, CaseInsensitiveString b,
        CaseInsensitiveStringComparison comparisonType) =>
    ...
    public static int Compare(CaseInsensitiveString a, CaseInsensitiveString b, CultureInfo culture,
        CaseInsensitiveStringCompareOptions compareOptions) =>
        string.Compare(a._value, b._value, culture, compareOptions.ToStringCompareOptions());

    public static int Compare(CaseInsensitiveString a, CaseInsensitiveString b, CaseInsensitiveStringComparison comparisonType) =>
    ...
    public static int Compare(CaseInsensitiveString a, int indexA, CaseInsensitiveString b, int indexB, int length,
        CultureInfo culture, CaseInsensitiveStringCompareOptions compareOptions) =>
