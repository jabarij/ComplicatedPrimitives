...
partial class RangeTests
{
    public class IsProperSupersetOf : RangeTests
    {
        ...
        public void ProperSupersetSharingLeftLimitValue_ShouldReturnTrue(double left, double right, double otherLeft, double otherRight, bool expected, string because)
        {
            // arrange
